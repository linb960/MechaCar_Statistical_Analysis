...
#### Data
The data would need to a survey of individuals.  Given a list of different cars, all similiar to MechaCar, would the individual buy the car.  If yes,  additional data can be gathered to help the manufacture with production such as why they said yes, was it price, features, mpg or how it rides, for example.  If they answer no then we could ask questions about what might change their mind.  Enough data needs to be collected to make this a viable analysis and the determination for the number of surveys sent out would need to be calculated.  Also, surveys should be done in various different parts of the country to determine if this type of vehicle can sell amoungst different types of populations.
